...
import type { IpcContext } from "../../../ipc/registerIpcHandlers";
import type { KuaishouElementKey, KuaishouFormState, KuaishouOptionField, KuaishouUploadTaskInput } from "../../../../shared/kuaishou/types";
import { RpaDriver } from "../../../rpa/RpaDriver";
import { defaultKuaishouElementProfile } from "../profiles/defaultKuaishouElementProfile";
import { isKuaishouPageActionError } from "../page/KuaishouPageBinding";
import { KuaishouUploadAdapter } from "../service/KuaishouUploadAdapter";
