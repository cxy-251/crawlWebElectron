...
from macrpa.paths import default_config_path, repository_root, source_root
...
class RpaApplication:
    def __init__(
        ...
        self.scheduler = LaunchdScheduler(self.home, repository_root(), source_root())
        self._open = False
...
def default_home() -> Path:
    return Path(
        os.environ.get("SAFARI_RPA_HOME")
        or os.environ.get("MACRPA_HOME", repository_root() / "local-api-usage" / "safari-rpa" / "var")
    )
