...
PYTHONPATH=src conda run -n kwai safari-rpa run \
  boss.search-and-communicate.v1 --config configs/boss.collection.yaml
...
PYTHONPATH=src conda run -n kwai safari-rpa run \
  boss.search-and-communicate.v1 --config configs/boss.test.yaml
...
PYTHONPATH=src conda run -n kwai safari-rpa run \
  boss.search-and-communicate.v1 --config configs/boss.production.yaml
