...
This repository uses small verified commits. Runtime output, credentials, local configuration, and personal paths are not committed. In Browser Workflow Forge this runtime lives under `runtimes/safari-rpa/`; Electron talks only to the versioned service API.
