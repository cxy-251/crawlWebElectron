...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--home", type=Path, help="Runtime state directory (default: SAFARI_RPA_HOME, MACRPA_HOME, or ./var)")
    ...
    twitter_collect.add_argument("--config", type=Path, default=Path("configs/twitter.collect.example.yaml"))
    twitter_collect.add_argument("--input", type=Path, default=Path("configs/twitter-target.example.json"))
    twitter_clean = twitter_subparsers.add_parser("clean", help="Clean previously collected Twitter raw tweets")
    twitter_clean.add_argument("--config", type=Path, default=Path("configs/twitter.clean.example.yaml"))
    twitter_clean.add_argument("--input", type=Path, default=Path("configs/twitter-target.example.json"))
